...
% Load the signal
filename = '/aux/MINDLAB2016_MR-demonstratives/DataCollectionMay/DefStimuli/group_2a.wav';
output_filename = 'envelope_subj14';
...
R = [repmat(0,1,28) left_envelope_resampled(1, 1:3642); repmat(0,1,28) right_envelope_resampled(1,1:3642)]';
cd(output_dir);
