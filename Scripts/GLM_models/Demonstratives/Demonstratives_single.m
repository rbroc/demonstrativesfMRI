function out = Demonstratives_single(input)
...
results_dir=['/projects/' project '/result/Oct18_Final/FIR_analysis/Demonstratives/'];
...
%the spm jobmanager
spm_jobman('serial',matlabbatch,'',matrix_dir, files, parfile, mov_reg);
