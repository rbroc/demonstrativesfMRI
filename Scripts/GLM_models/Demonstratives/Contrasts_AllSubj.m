...
jobfile = 'additional_constrasts_LR.mat';
...
for s = subjects
    ...
    mat_folder = [sprintf('/projects/MINDLAB2016_MR-demonstratives/result/Oct18_Final/FIR_analysis/Demonstratives/%03d',s)];
    cd(mat_folder);
