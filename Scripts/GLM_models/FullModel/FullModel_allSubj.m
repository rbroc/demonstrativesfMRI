function jobid = FullModel_allSubj(debug)
% Hv words: fill in batch for first-level model for all subjects and estimate it
...
for s=014
           ...
           if s == 014
               input(c).parfile = {['/projects/' project '/scripts/Oct18_Final/ParFiles/full_model_subj14.mat']};
            elseif ismember(s, group_1a)
                input(c).parfile= {['/projects/' project '/scripts/Oct18_Final/ParFiles/full_model_1.mat']};
            elseif ismember(s, group_1b)
                input(c).parfile= {['/projects/' project '/scripts/Oct18_Final/ParFiles/full_model_1.mat']};
            elseif ismember(s, group_2a)
                input(c).parfile= {['/projects/' project '/scripts/Oct18_Final/ParFiles/full_model_2.mat']};
            else
                input(c).parfile= {['/projects/' project '/scripts/Oct18_Final/ParFiles/full_model_2.mat']};
           end
...
if nargin >0
    ...
    jobid = job2cluster(@FullModel_single, input)
end
