...
for i = 1:20
matlabbatch{1}.spm.stats.con.consess{i}.tcon.name = ['Bin_' sprintf('%02d',i) '_SpeechAvg'];
matlabbatch{1}.spm.stats.con.consess{i}.tcon.weights = [zeros(1,160) zeros(1,i - 1) -1 zeros(1,19) -1 zeros(1,19) -1 zeros(1,19) -1 zeros(1,20 - i)];
